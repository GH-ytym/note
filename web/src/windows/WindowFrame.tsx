...
export default function WindowFrame({
  ...
  closeLabel = "关闭当前窗口",
  onBack,
}: { title: string; subtitle?: string; children: ReactNode; className?: string; closeLabel?: string; onBack?: () => void }) {
  return (
...
export function LoadingWindow({ title, message = "正在读取…", onBack }: { title: string; message?: string; onBack?: () => void }) {
  return (
